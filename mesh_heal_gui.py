...
class SurfaceShellBatchTab(BaseOperationTab):
    def __init__(self):
        ...
        self.items_tree.setHorizontalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        self.items_tree.setHorizontalScrollMode(QAbstractItemView.ScrollPerPixel)
        header = self.items_tree.header()
        header.setStretchLastSection(False)
        header.setSectionResizeMode(0, QHeaderView.Interactive)
        header.setSectionResizeMode(1, QHeaderView.Interactive)
        header.setSectionResizeMode(2, QHeaderView.Interactive)
        self.items_tree.setColumnWidth(0, 420)
        self.items_tree.setColumnWidth(1, 90)
        self.items_tree.setColumnWidth(2, 420)
